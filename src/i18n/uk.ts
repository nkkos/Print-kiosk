...
export const uk: Translations = {
  common: {
    ...
    scaleFit: 'За розміром паперу',
    scaleOriginal: 'Оригінальний розмір',
    comingSoon: 'Скоро',
  ...
  scan: {
    qrImageAlt: 'QR-код для відкриття камери сканування на телефоні',
    preparingQrCode: 'Підготовка QR-коду...',
    qrHint: 'Відскануйте камерою телефону, щоб сфотографувати та обробити документ',
    ...
    methodEmail: 'email',
    methodLink: 'посилання для завантаження',
  ...
  printOrderConfiguration: {
    ...
    orientationLegend: 'Орієнтація',
    scaleLegend: 'Масштаб',
    sidesLegend: 'Сторони',
    colorLegend: 'Колір',
    pagesLegend: 'Сторінки',
    pagesAll: 'Усі сторінки',
    pagesCustom: 'Вказати діапазон',
    quantity: 'Кількість',
  ...
  printStatus: {
    ...
    errorPrinterError:
      'Принтер потребує обслуговування. Персонал уже повідомлено — спробуйте трохи пізніше.',
